      ...
      if (!store.getters.info) {
        (async function getAddRouters () {
          fetchUser.fetchGetUserInfo().then(async function (response) {
            // let data = {
            //   authorityRouter: "12,13,14,15,16,17,18,1009,1010,1011,1012,1013,1014,1015,1016,1017,1018,10181,10182,1019,1020,1021,1022,1023,1024,1025,1026,1027,1028,1029,1030,10301,1031,1032,10181,1033,1034,1035,10412,1036,1037,1038,1039,10391,1040,1041,10410,10411,1042,1043,1044,1045,1046,1047,1048,1049,1050,111111",
            //   avatar: "https://mock.yonyoucloud.com/image/logo@1x.png",
            //   id: 37,
            //   name: "admin",
            //   permissionButton: "101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,53",
            //   role: "超级管理员"
            // }
