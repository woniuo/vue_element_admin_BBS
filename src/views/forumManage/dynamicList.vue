    ...
    <template>
      <el-card>
        <el-row :span="24">
          ...
          <el-col :span="12" align="right" v-if="multipleSelection.length>0">
            <el-button type="success" @click="setStatusAll(1)" v-role-btn="'66'">批量审核通过</el-button>
            <el-button type="primary" @click="setStatusAll(2)" v-role-btn="'66'">批量审核不通过</el-button>
            <el-button type="danger" @click="delStatusAll" v-role-btn="'67'">批量删除</el-button>
          </el-col>
        </el-row>
      </el-card>
      <el-table
      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button size="mini">
              <el-link :href="httpUrl+'/picture.html?id='+scope.row.id" target="_blank" v-role-btn="'65'">查看</el-link>
            </el-button>
            <el-popover
              placement="top"
              width="150"
            ...
            >
              ...
              <el-button size="mini" slot="reference" v-role-btn="'66'">状态修改</el-button>
            </el-popover>
            <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row.id)" v-role-btn="'67'">
